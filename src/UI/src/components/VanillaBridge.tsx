...
// NOT USED DIRECTLY BY THE MOD; used by VanillaComponentResolver. HAS FUTURE POTENTIAL
//
// Notes:
//   • This file is OPTIONAL. If unused, keeping it compilable is enough.
//   • Types are intentionally loose to avoid needing a local ./types file.
//   • If a module/theme is missing, entries remain undefined or {}.

import type { ModuleRegistry } from "cs2/modding";

// Vanilla Components: function exports copied out of ModuleRegistry.
export const VC: Record<string, any> = {};

// Vanilla Themes: SCSS "classes" maps.
export const VT: Record<string, any> = {};

// Vanilla Focus helpers.
export const VF: { FOCUS_DISABLED?: any; FOCUS_AUTO?: any } = {};

// Modules to pull component exports from.
const modulePaths: Array<{ path: string; components: string[] }> = [
    {
...
// Themes to pull "classes" exports from.
const themePaths: Array<{ path: string; name: string }> = [
    {
